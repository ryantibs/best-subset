...
reg.funs[["Best subset"]] = function(x,y) bs(x,y,intercept=FALSE,k=1:50,form=2)
reg.funs[["Relaxed lasso"]] = function(x,y) lasso(x,y,intercept=FALSE,nrelax=10,
                                                  nlam=50)
...
library(bestsubset)
load(file="rds/sim.n50.p1000.rda")
